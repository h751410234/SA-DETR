...
model_config_path = "config/nature/DINO_4scale.py" # change the path of the model config file
model_checkpoint_path = "checkpoint.pth" # change the path of the model checkpoint
