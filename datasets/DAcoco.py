...
class DADataset(Dataset):
    ...
    def __getitem__(self, idx):
        source_img, source_labels = self.source[idx % len(self.source)]
        target_img, target_labels = self.target[idx % len(self.target)]
        #DEBUG
        ...
        # print('111111111111')
        #
        return source_img, target_img, source_labels,target_labels
...
def build_dayfoggy(image_set, args):
...
def build_duskrainy(image_set, args):
...
def build_nightrainy(image_set, args):
...
def build_nightclear(image_set, args):
