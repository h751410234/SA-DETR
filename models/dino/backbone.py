...
from .style_projection import StyleRepresentation
...
class BackboneBase(nn.Module):
    ...
    def __init__(self, backbone: nn.Module, train_backbone: bool, num_channels: int, return_interm_indices: list,args_config):
        ...
        #----style_projection
        self.styleAdaIN1 = StyleRepresentation(num_prototype= 2,
                                        channel_size= 256,
        ...
        self.styleAdaIN2 = StyleRepresentation(num_prototype= 2,
                                        channel_size= 512,
                                        batch_size= self.args_config.batch_size,
                                        gamma= 0.9,
                                        dis_mode='was',
        ...
        self.styleAdaIN3 = StyleRepresentation(num_prototype= 2,
                                        channel_size= 1024,
                                        batch_size= self.args_config.batch_size,
                                        gamma= 0.9,
                                        dis_mode='was',
                                        channel_wise=False)
        #
        self.styleAdaIN4 = StyleRepresentation(num_prototype= 2,
                                        channel_size= 2048,
                                        batch_size= self.args_config.batch_size,
                                        gamma= 0.9,
                                        dis_mode='was',
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        #--convert 1----
        layer0_f = self.styleAdaIN1(layer0_f)  #检测不使用
        #************

        #第1层-  8倍下采样
        layer1_f = self.body.layer2(layer0_f)  #[b,512,h,w]
        #--convert 2----
        layer1_f = self.styleAdaIN2(layer1_f)
        #************

        #第2层-  16倍下采样
        layer2_f = self.body.layer3(layer1_f)  #[b,1024,h,w]
        #--convert 3----
        layer2_f = self.styleAdaIN3(layer2_f)
        #************

        #第3层-  32倍下采样
        layer3_f = self.body.layer4(layer2_f)  #[b,2048,h,w]
        #--convert 4----
        layer3_f = self.styleAdaIN4(layer3_f)
